...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('menu/dashboard'); ?>">
        <div class="sidebar-brand-icon">
          <i class="far fa-address-card"></i>
        </div>
        <div class="sidebar-brand-text mx-3">BPPRF<sub style="top: 0">ikom</sub></div>
      </a>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item <?= isset($dashboard) ? $dashboard : null; ?>">
      ...
      <?php
        if (isset($jurusan) || isset($kelas) || isset($calon) || isset($pemilih)) {
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <i class="far fa-user-circle fa-2x img-profile rounded-circle"></i>
              </a>
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="#">
                  <i class="fas fa-key fa-sm fa-fw mr-2 text-gray-400" style="margin-left: -8px;"></i>
                  Ubah Password
                </a>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                  <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400" style="margin-left: -8px;"></i>
                  Logout
                </a>
              </div>
            </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Hak Cipta &copy; BPPRFikom 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Silakan klik tombol dibawah ini jika Anda ingin keluar.</div>
